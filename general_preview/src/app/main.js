...
function installViewerFixCSS() {
  try {
    // Remove same-origin rules that force 100vh/100dvh/100vw in html.viewer
    for (const ss of Array.from(document.styleSheets)) {
      const href = ss.href || '';
      // Same-origin guard: if no href or same origin, we can edit; else skip
    ...
    // Inject our final style with !important, appended last
